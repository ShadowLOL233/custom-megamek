...
/** Outer Sphere Streak MML 5 - dual-mode (LRM/SRM) launcher with lock-on full salvo. */
public class OSStreakMML5 extends MMLWeapon {
    @Serial
    ...
    public OSStreakMML5() {
        super();
        name = "Streak MML 5";
        setInternalName("OSStreakMML5");
        addLookupName("OS Streak MML-5");
        addLookupName("OS Streak MML 5");
        sortingName = "Missile OS 4 4 1 05";
