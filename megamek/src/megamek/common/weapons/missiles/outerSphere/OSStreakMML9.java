...
/** Outer Sphere Streak MML 9 - dual-mode (LRM/SRM) launcher with lock-on full salvo. */
public class OSStreakMML9 extends MMLWeapon {
    @Serial
    ...
    public OSStreakMML9() {
        super();
        name = "Streak MML 9";
        setInternalName("OSStreakMML9");
        addLookupName("OS Streak MML-9");
        addLookupName("OS Streak MML 9");
        sortingName = "Missile OS 4 4 1 09";
