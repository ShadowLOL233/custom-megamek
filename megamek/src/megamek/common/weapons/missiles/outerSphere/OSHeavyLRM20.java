...
/**
 * Outer Sphere Heavy LRM 20 — Single / Ultra fire modes. Ultra fires two volleys in one turn (2x ammo,
 * 2x heat) and can jam on a natural-2 attack roll; Single is a plain LRM 20 (one volley, no jam).
 */
