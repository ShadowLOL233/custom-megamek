 ...
 */
public class OSAdvanceERPPC extends PPCWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSAdvanceERPPC() {
        super();
        name = "Advance ER PPC";
        setInternalName("OSAdvanceERPPC");
        addLookupName("OS Advance ER PPC");
        addLookupName("OSAdvERPPC");
        addLookupName("OS Adv. ER PPC");
        sortingName = "PPC OS 2 ER 2 Std 3 Adv";
        heat = 15;
        damage = 15;
        shortRange = 7;
        mediumRange = 14;
