 ...
 */
public class OSImpHeavyPulseLaserSmall extends PulseLaserWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSImpHeavyPulseLaserSmall() {
        super();
        name = "Imp. Hvy Small Pulse Laser";
        setInternalName("OSImpHeavySmallPulseLaser");
        addLookupName("OS Imp. Hvy Small Pulse Laser");
        addLookupName("OSImpHeavyPulseLaserSmall");
        sortingName = "Laser ImpHeavyPulse A";
        heat = 3;
        damage = 5;
        toHitModifier = -2;
        shortRange = 1;
