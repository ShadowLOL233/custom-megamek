...
/**
 * Outer Sphere Heavy Small Laser
 * Damage 6 / Heat 3 / Range 1-2-3 / +1 ToHit, 0.5t / 1 crit
 */
public class OSHeavyLaserSmall extends LaserWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSHeavyLaserSmall() {
        super();
