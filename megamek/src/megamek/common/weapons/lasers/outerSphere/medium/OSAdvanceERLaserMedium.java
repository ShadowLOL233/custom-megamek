 ...
 */
public class OSAdvanceERLaserMedium extends LaserWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSAdvanceERLaserMedium() {
        super();
        name = "Advance ER Medium Laser";
        setInternalName("OSAdvanceERMediumLaser");
        addLookupName("OS Advance ER Medium Laser");
        addLookupName("OSAdvanceERLaserMedium");
        sortingName = "Laser OS 03 ER 3 Adv B";
        heat = 6;
        damage = 8;
        toHitModifier = -1;
        shortRange = 5;
