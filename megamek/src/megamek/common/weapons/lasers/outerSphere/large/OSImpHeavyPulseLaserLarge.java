 ...
 */
public class OSImpHeavyPulseLaserLarge extends PulseLaserWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSImpHeavyPulseLaserLarge() {
        super();
        name = "Imp. Hvy Large Pulse Laser";
        setInternalName("OSImpHeavyLargePulseLaser");
        addLookupName("OS Imp. Hvy Large Pulse Laser");
        addLookupName("OSImpHeavyPulseLaserLarge");
        sortingName = "Laser ImpHeavyPulse D";
        heat = 14;
        damage = 13;
        toHitModifier = -2;
        shortRange = 5;
