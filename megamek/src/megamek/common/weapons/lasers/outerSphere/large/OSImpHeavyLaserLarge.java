 ...
 */
public class OSImpHeavyLaserLarge extends LaserWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSImpHeavyLaserLarge() {
        super();
        name = "Imp. Heavy Large Laser";
        setInternalName("OSImpHeavyLargeLaser");
        addLookupName("OS Imp. Heavy Large Laser");
        addLookupName("OSImpHeavyLaserLarge");
        sortingName = "Laser ImpHeavy D";
        heat = 18;
        damage = 16;
        shortRange = 5;
        mediumRange = 10;
