 ...
 */
public class OSAdvERPulseLaserLarge extends PulseLaserWeapon {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSAdvERPulseLaserLarge() {
        super();
        name = "Adv. ER Large Pulse Laser";
        setInternalName("OSAdvERLargePulseLaser");
        addLookupName("OS Adv. ER Large Pulse Laser");
        addLookupName("OSAdvERPulseLaserLarge");
        sortingName = "Laser AdvER Pulse D";
        heat = 18;
        damage = 14;
        toHitModifier = -3;
        shortRange = 6;
