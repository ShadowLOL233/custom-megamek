...
/**
 * Outer Sphere Heavy LRM Ultra-fire handler. The launcher has Single / Ultra fire modes. In Ultra it fires
 ...
 * natural-2 attack roll, exactly like an Ultra AC. In Single mode it is a plain LRM launcher — one volley, no jam.
 */
public class OSDoubleFireLRMHandler extends LRMHandler {
    @Serial
    private static final long serialVersionUID = 1L;

    public OSDoubleFireLRMHandler(ToHitData t, WeaponAttackAction w, Game g, TWGameManager m)
