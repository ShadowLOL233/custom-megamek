    ...
    protected double processWeapon(Mounted<?> weapon, boolean showInReport, boolean addToOffensiveValue,
        ...
        if (weapon.getType() instanceof WeaponType weaponType) {
            ...
            if ((weapon.getLinkedBy() != null) && (weapon.getLinkedBy().getType() instanceof MiscType)) {
                ...
                } else if (linkedBy.getType().hasFlag(MiscType.F_OS_ARTEMIS_V)) {
                    weaponBV *= 1.25;
                    calculation += " x 1.25 (Artemis V)";
                } else if (linkedBy.getType().hasFlag(MiscType.F_OS_DIANA_IV)) {
                    weaponBV *= 1.3;
                    calculation += " x 1.3 (Diana IV)";
